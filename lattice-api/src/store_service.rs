...
impl StoreService for StoreServiceImpl {
    ...
    ) -> Result<Response<StoreRef>, Status> {
    ...
    async fn list(
        &self,
        request: Request<crate::proto::ListStoreRequest>,
    ) -> Result<Response<StoreList>, Status> {
        let req = request.into_inner();
        let parent_id = if let Some(pid) = req.parent_id {
            Some(Self::parse_uuid(&pid)?)
        } else {
    ...
    ) -> Result<Response<StoreDetails>, Status> {
        let store_id = Self::parse_uuid(&request.into_inner().id)?;
        self.backend
    ...
    async fn get_name(
        &self,
        request: Request<StoreId>,
    ) -> Result<Response<StoreNameResponse>, Status> {
        let store_id = Self::parse_uuid(&request.into_inner().id)?;
        self.backend
    ...
    async fn witness_log(
        &self,
        request: Request<WitnessLogRequest>,
    ) -> Result<Response<WitnessLogResponse>, Status> {
        let req = request.into_inner();
        let store_id = Self::parse_uuid(&req.store_id)?;
        self.backend
    ...
    async fn floating_intentions(
        &self,
        request: Request<StoreId>,
    ) -> Result<Response<FloatingIntentionsResponse>, Status> {
        let store_id = Self::parse_uuid(&request.into_inner().id)?;
        self.backend
            .store_floating(store_id)
            .await
            .map(|intentions| {
    ...
    async fn get_intention(
        &self,
        request: Request<GetIntentionRequest>,
    ) -> Result<Response<GetIntentionResponse>, Status> {
        let req = request.into_inner();
        let store_id = Self::parse_uuid(&req.store_id)?;
        match self
            .backend
            .store_get_intention(store_id, &req.hash_prefix)
            .await
        {
    ...
    async fn system_list(
        &self,
        request: Request<StoreId>,
    ) -> Result<Response<SystemListResponse>, Status> {
        let store_id = Self::parse_uuid(&request.into_inner().id)?;
        self.backend
            .store_system_list(store_id)
            .await
            .map(|entries| {
    ...
    async fn list_peers(
        &self,
        request: Request<StoreId>,
    ) -> Result<Response<crate::proto::PeerList>, Status> {
        let store_id = Self::parse_uuid(&request.into_inner().id)?;
        self.backend
    ...
    async fn revoke_peer(
        &self,
        request: Request<crate::proto::RevokePeerRequest>,
    ) -> Result<Response<Empty>, Status> {
        let req = request.into_inner();
        let store_id = Self::parse_uuid(&req.store_id)?;
        self.backend
    ...
    async fn get_peer_strategy(
        &self,
        request: Request<StoreId>,
    ) -> Result<Response<PeerStrategyResponse>, Status> {
        let store_id = Self::parse_uuid(&request.into_inner().id)?;
        self.backend
    ...
    async fn join(
        ...
        self.backend
            .store_join(&request.into_inner().token)
            .await
            .map(|store_id| {
                Response::new(crate::proto::JoinResponse {
    ...
    async fn invite(
        &self,
        request: Request<StoreId>,
    ) -> Result<Response<crate::proto::InviteToken>, Status> {
        let store_id = Self::parse_uuid(&request.into_inner().id)?;
        self.backend
