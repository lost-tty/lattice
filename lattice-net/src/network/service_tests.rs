...
mod tests {
    ...
    use lattice_model::{
        JoinAcceptanceInfo, NodeProvider, NodeProviderAsync, NodeProviderError, UserEvent, Uuid,
    };
    ...
    /// Minimal NodeProvider/NodeProviderAsync — never used beyond construction.
    struct MockProvider {
        pubkey: PubKey,
    ...
    impl MockProvider {
        ...
        fn with_registry(pubkey: PubKey, registry: Arc<dyn NetworkStoreRegistry>) -> Self {
